...
import { Github, PencilIcon, Trash2Icon, Clock, Zap, ArrowRight, MessageSquare } from "lucide-react";
          ...
          {!loading && (
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="destructive" size="sm" className="rounded-xl px-3">
